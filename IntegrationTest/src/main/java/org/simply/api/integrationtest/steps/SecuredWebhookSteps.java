...
public class SecuredWebhookSteps extends BaseSteps {
    ...
    @When("^the user post configuration as per (.+) payload to secured webhook$")
    public void the_user_calls_allowed_webhook_config_api(String payloadFilename) throws Exception {
